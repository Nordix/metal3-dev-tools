...
# move to capo repo
pushd "${CAPO_REPO}"
# replace cirros user by ubuntu, until the user is configurable in the test code
...
# To Do:
# The ssh key is not available until the make test-e2e runs. Figure out the order
# Or re-user an existing key-pair
