...
LOCAL_IRONIC_HWIRI_REPO="${WORKSPACE}/ironic-hardware-inventory-recorder-image.git"
...
LOCAL_MARIADB_IMAGE_REPO="${WORKSPACE}/mariadb-image.git"
...
UPSTREAM_REPO="${3:-${CAPM3_REPO} ${CAPO_REPO} ${CAPI_REPO} ${BMO_REPO} ${M3DOCS_REPO} ${M3DEVENV_REPO} ${PROJECTINFRA_REPO} ${IRONIC_IMAGE_REPO} ${IPAM_REPO} ${METAL3GITHUBIO_REPO} ${IPA_REPO} ${IPA_BUILDER_REPO} ${TOPOLVM_REPO} ${SRIOV_CNI_REPO} ${SRIOV_NDP_REPO} ${IPA_DOWNLOADER_REPO} ${DOT_GITHUB_REPO} ${IRONIC_HWIRI_REPO} ${MARIADB_IMAGE_REPO} ${NMSTATE_REPO}}"
...
CAPM3_RELEASE_BRANCHES="release-0.5 release-1.1 release-1.2 release-1.3 release-1.4 release-1.5"
update_custom_branch "$CAPM3_RELEASE_BRANCHES" "$LOCAL_CAPM3_REPO" "$NORDIX_CAPM3_REPO"

IPAM_RELEASE_BRANCHES="release-0.1 release-1.1 release-1.2 release-1.3 release-1.4 release-1.5"
update_custom_branch "$IPAM_RELEASE_BRANCHES" "$LOCAL_IPAM_REPO" "$NORDIX_IPAM_REPO"

CAPI_RELEASE_BRANCHES="release-0.4 release-1.1 release-1.2 release-1.3 release-1.4 release-1.5"
