...
UPDATE_REPO="${1:-${LOCAL_CAPM3_REPO} ${LOCAL_CAPO_REPO} ${LOCAL_CAPI_REPO} ${LOCAL_BMO_REPO} ${LOCAL_M3DOCS_REPO} ${LOCAL_M3DEVENV_REPO} ${LOCAL_PROJECTINFRA_REPO} ${LOCAL_IRONIC_IMAGE_REPO} ${LOCAL_IPAM_REPO} ${LOCAL_METAL3GITHUBIO_REPO} ${LOCAL_IPA_REPO} ${LOCAL_IPA_BUILDER_REPO} ${LOCAL_TOPOLVM} ${LOCAL_SRIOV_CNI_REPO} ${LOCAL_SRIOV_NDP_REPO} ${LOCAL_IPA_DOWNLOADER_REPO} ${LOCAL_DOT_GITHUB_REPO}} ${LOCAL_IRONIC_HWIRI_REPO} ${LOCAL_MARIADB_IMAGE_REPO}"
UPSTREAM_REPO="${3:-${CAPM3_REPO} ${CAPO_REPO} ${CAPI_REPO} ${BMO_REPO} ${M3DOCS_REPO} ${M3DEVENV_REPO} ${PROJECTINFRA_REPO} ${IRONIC_IMAGE_REPO} ${IPAM_REPO} ${METAL3GITHUBIO_REPO} ${IPA_REPO} ${IPA_BUILDER_REPO} ${TOPOLVM_REPO} ${SRIOV_CNI_REPO} ${SRIOV_NDP_REPO} ${IPA_DOWNLOADER_REPO} ${DOT_GITHUB_REPO} ${IRONIC_HWIRI_REPO} ${MARIADB_IMAGE_REPO}}"
