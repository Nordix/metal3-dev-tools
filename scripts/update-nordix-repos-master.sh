...
NORDIX_FALCO_REPO="git@github.com:falcosecurity/falco.git"
NORDIX_FALCO_LIBS_REPO="git@github.com:falcosecurity/libs.git"
NORDIX_FALCO_WEBSITE_REPO="git@github.com:falcosecurity/falco-website.git"
NORDIX_FALCOCTL_REPO="git@github.com:falcosecurity/falcoctl.git"
...
CAPI_RELEASE_BRANCHES="release-1.8 release-1.9 release-1.10"
update_custom_branch "${CAPI_RELEASE_BRANCHES}" "${LOCAL_CAPI_REPO}" "${NORDIX_CAPI_REPO}"

CAPO_RELEASE_BRANCHES="release-0.10 release-0.11 release-0.12"
