...
UPDATE_REPO="${1:-${LOCAL_CAPM3_REPO} ${LOCAL_CAPO_REPO} ${LOCAL_CAPI_REPO} ${LOCAL_BMO_REPO} ${LOCAL_M3DOCS_REPO} ${LOCAL_M3DEVENV_REPO} ${LOCAL_PROJECTINFRA_REPO} ${LOCAL_IRONIC_IMAGE_REPO} ${LOCAL_IPAM_REPO} ${LOCAL_METAL3GITHUBIO_REPO} ${LOCAL_IPA_REPO} ${LOCAL_IPA_BUILDER_REPO} ${LOCAL_IPA_DOWNLOADER_REPO} ${LOCAL_DOT_GITHUB_REPO} ${LOCAL_IRONIC_HWIRI_REPO} ${LOCAL_MARIADB_IMAGE_REPO} ${LOCAL_UTILITY_IMAGES_REPO} ${LOCAL_COMMUNITY_REPO} ${LOCAL_IRONIC_OPERATOR_REPO} ${LOCAL_FALCO_REPO} ${LOCAL_FALCO_LIBS_REPO} ${LOCAL_FALCO_WEBSITE_REPO} ${LOCAL_FALCOCTL_REPO}}"

UPSTREAM_REPO="${3:-${CAPM3_REPO} ${CAPO_REPO} ${CAPI_REPO} ${BMO_REPO} ${M3DOCS_REPO} ${M3DEVENV_REPO} ${PROJECTINFRA_REPO} ${IRONIC_IMAGE_REPO} ${IPAM_REPO} ${METAL3GITHUBIO_REPO} ${IPA_REPO} ${IPA_BUILDER_REPO} ${IPA_DOWNLOADER_REPO} ${DOT_GITHUB_REPO} ${IRONIC_HWIRI_REPO} ${MARIADB_IMAGE_REPO} ${UTILITY_IMAGES_REPO} ${COMMUNITY_REPO} ${IRONIC_OPERATOR_REPO} ${FALCO_REPO} ${FALCO_LIBS_REPO} ${FALCO_WEBSITE_REPO} ${FALCOCTL_REPO}}"

NORDIX_REPO="${4:-${NORDIX_CAPM3_REPO} ${NORDIX_CAPO_REPO} ${NORDIX_CAPI_REPO} ${NORDIX_BMO_REPO} ${NORDIX_M3DOCS_REPO} ${NORDIX_M3DEVENV_REPO} ${NORDIX_PROJECTINFRA_REPO} ${NORDIX_IRONIC_IMAGE_REPO} ${NORDIX_IPAM_REPO} ${NORDIX_METAL3GITHUBIO_REPO} ${NORDIX_IPA_REPO} ${NORDIX_IPA_BUILDER_REPO} ${NORDIX_IPA_DOWNLOADER_REPO} ${NORDIX_DOT_GITHUB_REPO} ${NORDIX_IRONIC_HWIRI_REPO} ${NORDIX_MARIADB_IMAGE_REPO} ${NORDIX_UTILITY_IMAGES_REPO} ${NORDIX_COMMUNITY_REPO} ${NORDIX_IRONIC_OPERATOR_REPO} ${NORDIX_FALCO_REPO} ${NORDIX_FALCO_LIBS_REPO} ${NORDIX_FALCO_WEBSITE_REPO} ${NORDIX_FALCOCTL_REPO}}"
