...
LOCAL_REPOS=(
  ...
  "${LOCAL_DOT_GITHUB_REPO}" "${LOCAL_IRONIC_HWIRI_REPO}" "${LOCAL_MARIADB_IMAGE_REPO}" "${LOCAL_NMSTATE_REPO}"
  "${LOCAL_NFD_REPO}" "${LOCAL_UTILITY_IMAGES_REPO}" "${LOCAL_COMMUNITY_REPO}" "${LOCAL_IRONIC_OPERATOR_REPO}"
  "${LOCAL_FALCO_REPO}" "${LOCAL_FALCO_LIBS_REPO}" "${LOCAL_FALCO_WEBSITE_REPO}" "${LOCAL_FALCOCTL_REPO}"
)
...
UPSTREAM_REPOS=(
  ...
  "${DOT_GITHUB_REPO}" "${IRONIC_HWIRI_REPO}" "${MARIADB_IMAGE_REPO}" "${NMSTATE_REPO}"
  "${NFD_REPO}" "${UTILITY_IMAGES_REPO}" "${COMMUNITY_REPO}" "${IRONIC_OPERATOR_REPO}"
  "${FALCO_REPO}" "${FALCO_LIBS_REPO}" "${FALCO_WEBSITE_REPO}" "${FALCOCTL_REPO}"
)
...
NORDIX_REPOS=(
  ...
  "${NORDIX_DOT_GITHUB_REPO}" "${NORDIX_IRONIC_HWIRI_REPO}" "${NORDIX_MARIADB_IMAGE_REPO}" "${NORDIX_NMSTATE_REPO}"
  "${NORDIX_NFD_REPO}" "${NORDIX_UTILITY_IMAGES_REPO}" "${NORDIX_COMMUNITY_REPO}" "${NORDIX_IRONIC_OPERATOR_REPO}"
  "${NORDIX_FALCO_REPO}" "${NORDIX_FALCO_LIBS_REPO}" "${NORDIX_FALCO_WEBSITE_REPO}" "${NORDIX_FALCOCTL_REPO}"
)
