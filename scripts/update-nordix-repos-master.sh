...
LOCAL_REPOS=(
  ...
  "${LOCAL_NMSTATE_REPO}" "${LOCAL_NRI_PLUGINS_REPO}" "${LOCAL_UTILITY_IMAGES_REPO}" "${LOCAL_COMMUNITY_REPO}"
  "${LOCAL_IRONIC_OPERATOR_REPO}" "${LOCAL_FALCO_REPO}" "${LOCAL_FALCO_LIBS_REPO}" "${LOCAL_FALCO_WEBSITE_REPO}"
  "${LOCAL_FALCOCTL_REPO}"
)
...
UPSTREAM_REPOS=(
  ...
  "${NMSTATE_REPO}" "${NRI_PLUGINS_REPO}" "${UTILITY_IMAGES_REPO}" "${COMMUNITY_REPO}"
  "${IRONIC_OPERATOR_REPO}" "${FALCO_REPO}" "${FALCO_LIBS_REPO}" "${FALCO_WEBSITE_REPO}"
  "${FALCOCTL_REPO}"
)
...
NORDIX_REPOS=(
  ...
  "${NORDIX_NMSTATE_REPO}" "${NORDIX_NRI_PLUGINS_REPO}" "${NORDIX_UTILITY_IMAGES_REPO}" "${NORDIX_COMMUNITY_REPO}"
  "${NORDIX_IRONIC_OPERATOR_REPO}" "${NORDIX_FALCO_REPO}" "${NORDIX_FALCO_LIBS_REPO}" "${NORDIX_FALCO_WEBSITE_REPO}"
...
IRONIC_IMAGE_RELEASE_BRANCHES="release-26.0 release-27.0 release-28.0 release-29.0 release-30.0"
update_custom_branch "${IRONIC_IMAGE_RELEASE_BRANCHES}" "${LOCAL_IRONIC_IMAGE_REPO}" "${NORDIX_IRONIC_IMAGE_REPO}"

IRONIC_OPERATOR_RELEASE_BRANCHES="release-0.4"
