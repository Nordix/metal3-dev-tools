...
NORDIX_FALCO_REPO="git@ithub.com:falcosecurity/falco.git"
NORDIX_FALCO_LIBS_REPO="git@ithub.com:falcosecurity/libs.git"
NORDIX_FALCO_WEBSITE_REPO="git@ithub.com:falcosecurity/falco-website.git"
NORDIX_FALCOCTL_REPO="git@ithub.com:falcosecurity/falcoctl.git"
