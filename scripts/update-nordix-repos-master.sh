...
IRONIC_CLIENT_REPO="https://github.com/metal3-io/ironic-client.git"
...
NORDIX_IRONIC_CLIENT_REPO="git@github.com:Nordix/ironic-client.git"
...
LOCAL_IRONIC_CLIENT_REPO="${WORKSPACE}/ironic-client"
