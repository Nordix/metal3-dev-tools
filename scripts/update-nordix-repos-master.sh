...
IRONIC_HWIRI="https://github.com/metal3-io/ironic-hardware-inventory-recorder-image.git"
...
NORDIX_IRONIC_HWIRI="git@github.com:Nordix/ironic-hardware-inventory-recorder-image.git"
