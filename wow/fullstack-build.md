...
2. Create an indentifier tag from `ISO 8061` timestamp an IPA's git
   commit `sha hash`
...
Example of the location of a `Centos 9 Stream` based staging and review
artifacts:
...
The custumization options provide git repository, branch, commit and
